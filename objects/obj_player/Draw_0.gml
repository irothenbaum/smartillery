...
draw_sprite_ext(spr_player_body, 0, _body_x, _body_y, 1, 1, direction, c_white, 1)
...
draw_sprite_ext(spr_player_turret, 0, _turret_x, _turret_y, _turret_scale, 1, image_angle, c_white, 1)
