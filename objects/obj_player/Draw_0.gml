...
var _body_x = x + lengthdir_x(-recoil_amount / 3, image_angle) + 1 // the +1 is to corect a rounding erorr when scaling the sprite
var _body_y = y + lengthdir_y(-recoil_amount / 3, image_angle) + 1
