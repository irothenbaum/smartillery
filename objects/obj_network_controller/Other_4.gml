...
instance_create_layer(x, y, LAYER_INSTANCES, obj_input, {owner_steam_id: global.my_steam_id})
instance_create_layer(x, y, LAYER_INSTANCES, obj_input, {owner_steam_id: global.partner_steam_id})