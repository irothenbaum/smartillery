// Draw black hole during spawn animation (phases 0, 1, 2)
if (spawn_phase < total_spawn_phases && blackhole_radius > 0) {
	draw_set_color(c_black)
	draw_circle(x, y, blackhole_radius, false)
}

// Only draw enemy sprite after we've finished spawning entirely
